...
func fechar_portas(vizinhos:Array):
	for c in vizinhos:
		...
		if c == "S":
			tilemap.set_cell(Vector2i(7,7),6,Vector2i(0,3),0)
		if c == "L":
			tilemap.set_cell(Vector2i(13,4),6,Vector2i(0,1),0)
		if c == "O":
			tilemap.set_cell(Vector2i(1,4),6,Vector2i(0,2),0)
...
func abrir_portas(vizinhos:Array):
	...
	for c in vizinhos:
		...
		if c == "S":
			tilemap.set_cell(Vector2i(7,7),5,Vector2i(0,3),0)
		if c == "L":
			tilemap.set_cell(Vector2i(13,4),5,Vector2i(0,1),0)
		if c == "O":
			tilemap.set_cell(Vector2i(1,4),5,Vector2i(0,2),0)
